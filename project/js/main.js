...
class ProductList {
    ...
    // Задание 2. Добавить метод, определяющий суммарную стоимость всех товаров
    sumGoodsPrice() {

        let summary = this._goods.reduce(function (sum, { price }) {
            return sum + price;
        }, 0);
        return summary;
    }
...
console.log(catalog.sumGoodsPrice());
// const products = [
//   {id: 1, title: 'Notebook', price: 20000},
//   {id: 2, title: 'Mouse', price: 1500},
//   {id: 3, title: 'Keyboard', price: 5000},
